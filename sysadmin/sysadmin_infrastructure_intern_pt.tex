...
\begin{itemize}
	...
	\item Implementei arquitetura de dom\'{i}nio duplo: \texttt{glza.xyz} (somente VPN) e \texttt{glza.cloud} (p\'{u}blico) com SSL/TLS automatizado via Certbot e desafios DNS Cloudflare.
...
\begin{description}
	...
	\item[Monitoramento] Prometheus, Grafana, Scrutiny, Glance
